...
/**
  ...
  @return        execution  status
                   - \ref XTENSA_MATH_SUCCESS      : Operation successful
                   - \ref XTENSA_MATH_LENGTH_ERROR : <code>blockSize</code> is not a multiple of <code>M</code>
...
xtensa_status xtensa_fir_decimate_init_q31(
        xtensa_fir_decimate_instance_q31 * S,
        uint16_t numTaps,
        uint8_t M,
  const q31_t * pCoeffs,
        q31_t * pState,
